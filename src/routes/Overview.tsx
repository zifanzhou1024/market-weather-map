  ...
  return (
    <main className="page-shell">
      <section className="page-heading">
        <p className="eyebrow" lang="en">Market weather</p>
        <h2>{t("routes.overviewHeading")}</h2>
        <p lang="en">Cross-asset conditions summarized from static JSON generated by GitHub Actions.</p>
      </section>
      {error ? (
      ...
      {mode === "detail" ? (
        <ContextBlock label="Score contributions, driver attribution, missing data, and horizon impact">
