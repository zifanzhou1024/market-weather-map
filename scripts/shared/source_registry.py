...
def source_registry_entries() -> dict[str, dict[str, object]]:
    return {
        ...
        "ice_indices": {
            "access_status": "restricted_vendor",
            "active_scoring_allowed": False,
        ...
        "ny_fed": {
            ...
            "notes": "Public Federal Reserve research data; ACM term-premium approved for active scoring per docs/source_reviews/ny_fed_acm_term_premium.md.",
            "public_redistribution_allowed": True,
            "requires_secret": False,
            "terms_status": "review_each_series",
            "update_cadence": "daily_release",
        },
        "occ": {
            "access_status": "terms_review_needed",
            "active_scoring_allowed": False,
